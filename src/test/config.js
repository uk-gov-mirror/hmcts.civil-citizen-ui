...
module.exports = {
  ...
  url: {
    ...
    manageCase: process.env.EXUI_URL || 'https://manage-case.aat.platform.hmcts.net/',
    authProviderApi: process.env.SERVICE_AUTH_PROVIDER_API_BASE_URL || 'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal',
    ...
    idamWeb: process.env.IDAM_WEB_URL || 'https://idam-web-public.aat.platform.hmcts.net',
    ...
    generalApplication: process.env.CIVIL_GENERAL_APPLICATIONS_URL || 'http://civil-general-applications-aat.service.core-compute-aat.internal',
    caseAssignmentService: process.env.AAC_API_URL || 'http://aac-manage-case-assignment-aat.service.core-compute-aat.internal',
